...
export default function Footer() {
  return (
    <footer className="bg-light flex flex-col xl:flex-row justify-center items-center gap-4 xl:gap-0 xl:justify-between w-full p-5 mt-44 font-nunito xl:container mx-auto">
      <div>
        <Logo />
      </div>
      <div>
