	...
	return (
		<section className="lg:px-20 px-4 grid lg:grid-cols-2  lg:h-[580px] relative 2xl:container mx-auto bg-[#f8e7d4]">
			<div className="lg:w-[600px] lg:h-auto h-[60rem]">
				<h1 className="lg:text-6xl tracking-tight text-4xl font-onest-bold  lg:mt-32 mt-16 text-slate-950 text-balance">
			...
			<div className="relative lg:mt-5 mt-16 lg:block">
				...
				<Image
					...
					width="202"
					height="200"
					className="absolute  -left-4 bottom-[15rem] w-[200px] h-auto md:w-[202px] md:left-44 lg:right-[45%] lg:top-[290px]  lg:w-auto lg:h-auto z-10"
					priority={true}
				/>
				<Image
					src="/plate1.png"
