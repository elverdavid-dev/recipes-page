...
const SectionHero = () => {
	return (
		<section className=" px-2 md:max-w-6xl  relative 2xl:container mx-auto">
			<h1 className="lg:text-6xl tracking-tight text-4xl text-center  lg:mt-32 mt-16 dark:text-white text-balance font-extrabold">
				Explora recetas de todo el
				<strong className="text-gold"> Mundo</strong>
			</h1>
			<div className="flex items-center flex-col">
				<p className="text-lg block mt-4 text-pretty md:text-center">
